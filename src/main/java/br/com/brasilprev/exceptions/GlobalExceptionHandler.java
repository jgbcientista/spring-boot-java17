...
import br.com.brasilprev.exceptions.service.AuthorizationException;
import br.com.brasilprev.exceptions.service.DataBindingViolationException;
import br.com.brasilprev.exceptions.service.ObjectNotFoundException;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler implements AuthenticationFailureHandler {
	...
	public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response,
		...
		ErrorResponse errorResponse = new ErrorResponse(status, "Usuario ou senha invalido(s)");
